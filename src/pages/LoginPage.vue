      ...
      <div class="login-card">
        ...
        <q-form class="login-form" @submit="onSubmit">
          ...
          <div class="login-form-group">
            ...
            <input type="email" id="email" class="login-form-input" placeholder="Digite seu email">
          </div>

          <div class="login-form-group">
            <label class="login-form-label" for="senha">Senha <span class="is-required">*</span></label>
            <input type="password" id="senha" class="login-form-input" placeholder="Digite sua senha">
          </div>

          <div class="login-form-button-container">
            <button class="login-form-button" label="Submit" type="submit">Login</button>
          </div>
